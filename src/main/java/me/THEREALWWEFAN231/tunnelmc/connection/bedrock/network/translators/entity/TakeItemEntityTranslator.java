...
public class TakeItemEntityTranslator extends PacketTranslator<TakeItemEntityPacket> {
	...
	@Override
	public void translate(TakeItemEntityPacket packet, BedrockConnection bedrockConnection) {
		...
		bedrockConnection.javaConnection.processServerToClientPacket(itemPickupAnimationS2CPacket);
	}
}
