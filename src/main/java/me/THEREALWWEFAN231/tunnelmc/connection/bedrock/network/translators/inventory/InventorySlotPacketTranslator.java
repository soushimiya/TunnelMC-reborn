...
import me.THEREALWWEFAN231.tunnelmc.connection.java.network.translators.UpdateSelectedSlotC2SPacketTranslator;
...
public class InventorySlotPacketTranslator extends PacketTranslator<InventorySlotPacket> {
	...
	public void translate(InventorySlotPacket packet, Client client) {
		...
		if (packetSlot == TunnelMC.mc.player.getInventory().selectedSlot) {
			UpdateSelectedSlotC2SPacketTranslator.updateHotbarItem(packetSlot, client);
		}
	}
