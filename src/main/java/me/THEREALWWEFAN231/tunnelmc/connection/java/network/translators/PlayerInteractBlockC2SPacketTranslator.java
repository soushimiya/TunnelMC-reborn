...
public class PlayerInteractBlockC2SPacketTranslator extends PacketTranslator<PlayerInteractBlockC2SPacket> {
	...
	@Override
	public void translate(PlayerInteractBlockC2SPacket packet, Client client) {
		...
		ItemData placingItem = client.containers.getPlayerInventory().getItemFromSlot(TunnelMC.mc.player.getInventory().selectedSlot);
		...
		client.sendPacket(placeInventoryTransactionPacket);
		...
		client.sendPacket(idkInventoryTransactionPacket);
